    ...
    */
    ...
    LGraphNode.prototype.computeSize = function(out) {
        ...
        if (!LGraphNode.ctx) {
            ...
            LGraphNode.ctx = canvas.getContext('2d');
            LGraphNode.ctx.font = '14px Arial';
        }
        const ctx = LGraphNode.ctx;
        const tm = ctx.measureText(this.title);
        var title_width = tm.width;
        ...
        size[0] = title_width + activebox_width + 35;
...
*/
    ...
    LGraphGroup.prototype._ctor = function(title) {
        ...
        this.font_size = 24;
        this.color = global.LGraphCanvas.node_colors.pale_blue
            ? global.LGraphCanvas.node_colors.pale_blue.groupcolor
            : "#AAA";
